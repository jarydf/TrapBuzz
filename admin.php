...
<body>
    <header>
        <a href="admin.php" title="Home"> <img class="icons" id="logo" src="TrapBuzz.png" alt="logo"></a>
        ...
        <nav>
           ...
           ?> </li>
                <li><a href="admin.php"> <img class="icons" src="006-home-page.svg" title="Home" alt="Home" /></a></li>
