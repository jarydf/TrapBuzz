...
// this function takes in  title, id,  date, content and picture($param6) and dislpays it
 function displayContent_blogs($param1, $param2, $param3, $param4, $param5, $param6,$param7){
   ...
   <div class="comments">
    <a class="newlike" href="newLikePost.php" id="'.$param7.'"><img src="002-thumbs-up-hand-symbol.svg" class="candl"/>
    </a>
   ...
   ?>
    ...
    $(document).ready(function(){
        setInterval(function() {
            $("#numOfLikes").load("newLikePost.php");
        }, 10000);
    });
</script>
...
echo'
      <p> <a href=hotPost-inc.php?blogId='.$param5.'> <img class = "hotprofilepic" src="005-man-user.svg" alt="Profile"/> by '.$param1.' on<time datetime="'.
